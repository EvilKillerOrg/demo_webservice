 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://impl.sei.service.jdk.ek.com/", wsdlLocation = "http://localhost:8088/demo_webservice/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://impl.sei.service.jdk.ek.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/demo_webservice/hellows?wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://impl.sei.service.jdk.ek.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.sei.service.jdk.ek.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
