 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/x-client-weather-jdk/src/main/java/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/x-client-weather-jdk/src/main/java/weather.wsdl");
