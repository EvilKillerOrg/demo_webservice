 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://sei.hello.ws.ek.com/", wsdlLocation = "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/jdk-client/src/main/java/hellows.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/jdk-client/src/main/java/hellows.wsdl");
