 ...
 * generated in the com.ek.ws.spring.sei package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://sei.spring.ws.ek.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://sei.spring.ws.ek.com/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ek.ws.spring.sei
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sei.spring.ws.ek.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sei.spring.ws.ek.com/", name = "getOrderByIdResponse")
