 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://sei.hello.ws.ek.com/", wsdlLocation = "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/ws-client-jdk/src/main/java/hellows.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://sei.hello.ws.ek.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/ws-client-jdk/src/main/java/hellows.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://sei.hello.ws.ek.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sei.hello.ws.ek.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
