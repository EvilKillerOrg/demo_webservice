 ...
 * 2018-01-31T02:23:45.930+08:00
 * Generated source version: 3.1.2
 * 
 */
@WebServiceClient(name = "LoggingInterceptorImplService", 
                  wsdlLocation = "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/cxf-client/src/main/java/loggingInterceptorws.wsdl",
...
public class LoggingInterceptorImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/cxf-client/src/main/java/loggingInterceptorws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LoggingInterceptorImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/cxf-client/src/main/java/loggingInterceptorws.wsdl");
        }
        WSDL_LOCATION = url;
    }
