 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/weather-client/src/main/java/weather.wsdl")
public class WeatherWebService extends Service {
  ...
  static {
    ...
    try {
      url = new URL("file:/E:/Workspace/eclipse/workspace4.5/demo_webservice/weather-client/src/main/java/weather.wsdl");
